...
package org.neodapps.plugin.settings;
...
public class SettingsComponent implements Disposable {
  ...
  public JPanel getPanel() {
    ...
    var content = FormBuilder.createFormBuilder()
        .addLabeledComponent(new JBLabel(MessageBundle.message("settings.dotnet.picker")),
            dotNetRoot, 1, false)
        .addLabeledComponent(new JBLabel(MessageBundle.message("settings.neo.picker")),
            neoExpressExecutablePath, 1, false)
        .addComponent(new JBLabel(MessageBundle.message("settings.neo.hint")))
        .getPanel();
