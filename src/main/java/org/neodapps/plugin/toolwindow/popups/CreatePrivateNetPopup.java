...
package org.neodapps.plugin.toolwindow.popups;
...
import org.neodapps.plugin.neoexpress.service.NeoExpressService;
...
public class CreatePrivateNetPopup implements Disposable, ActionListener {
  ...
  private JBLoadingPanel getComponent() {
    ...
    nameField = new JTextField(MessageBundle.message("toolwindow.private.net.default.name"));
    builder.addLabeledComponent(
        new JBLabel(MessageBundle.message("toolwindow.private.net.prompt.name")), nameField,
        true);

    nodeList = new JBList<>(Arrays.asList(1, 4, 7));
    nodeList.setSelectedIndex(ListSelectionModel.SINGLE_SELECTION);
    builder.addLabeledComponent(
        new JBLabel(MessageBundle.message("toolwindow.private.net.prompt.nodes")),
        new JBScrollPane(nodeList), true);

    JButton ok = new JButton();
    ok.setText(MessageBundle.message("toolwindow.private.net.prompt.action"));
  ...
  public void showPopup() {
    ...
    builder.setTitle(MessageBundle.message("toolwindow.private.net.prompt.title"));
